...
class Payload extends \AppBundle\Entity\Payload implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function addCommit(\AppBundle\Entity\Commit $commit)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCommit', [$commit]);

        return parent::addCommit($commit);
    }
    ...
    public function removeCommit(\AppBundle\Entity\Commit $commit)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCommit', [$commit]);

        return parent::removeCommit($commit);
    }
    ...
    public function getCommits()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCommits', []);

        return parent::getCommits();
    }
