...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.commit_manager' => 'getApp_CommitManagerService',
            'app.file_manager' => 'getApp_FileManagerService',
            'app.payload_manager' => 'getApp_PayloadManagerService',
            'app.repository_manager' => 'getApp_RepositoryManagerService',
            'app.user_manager' => 'getApp_UserManagerService',
    ...
    /**
     * Gets the 'app.commit_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Manager\CommitManager A AppBundle\Manager\CommitManager instance.
     */
    protected function getApp_CommitManagerService()
    {
        return $this->services['app.commit_manager'] = new \AppBundle\Manager\CommitManager($this->get('doctrine.orm.default_entity_manager'), $this->get('app.file_manager'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Manager\FileManager A AppBundle\Manager\FileManager instance.
     */
    protected function getApp_FileManagerService()
    {
        return $this->services['app.file_manager'] = new \AppBundle\Manager\FileManager($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.payload_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Manager\PayloadManager A AppBundle\Manager\PayloadManager instance.
     */
    protected function getApp_PayloadManagerService()
    {
        return $this->services['app.payload_manager'] = new \AppBundle\Manager\PayloadManager($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.repository_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Manager\RepositoryManager A AppBundle\Manager\RepositoryManager instance.
     */
    protected function getApp_RepositoryManagerService()
    {
        return $this->services['app.repository_manager'] = new \AppBundle\Manager\RepositoryManager($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.user_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['app.user_manager'] = new \AppBundle\Manager\UserManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'github-hook', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fd8fb75bc665dcb79897ccfb6dcd8a2584d435bd30d488c550a52874f2ff1212');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5717521c783522.77229325')), true);
